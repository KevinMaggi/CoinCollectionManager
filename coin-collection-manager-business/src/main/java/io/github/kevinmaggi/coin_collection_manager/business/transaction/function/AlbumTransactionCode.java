...
/**
 * This interface represents a piece of code that must be executed in a transaction and involve the {@code AlbumRepository} class.
 *
 * @param <R> returning type of the code
 */
@FunctionalInterface
public interface AlbumTransactionCode<R> extends Function<AlbumRepository, R> {}